...
(function() {
  ...
  ready = function() {
    document.getElementById('full_po_checkbox').onchange = function() {
      document.getElementById('received_qty').style.display = (this.checked ? "none" : "block");
      return document.getElementById('full_po_qty').style.display = (this.checked ? "block" : "none");
    };
  };
